...
const Data = () => {
  return (
    <div className="home__data">
        ...
        Honors B.A.Sc in Computer Science @ McMaster University 2025
        </h3>
        <p className="home__description">
        Final-year computer science student with co-op experience who is passionate about building efficient full-stack solutions.    
        </p>
